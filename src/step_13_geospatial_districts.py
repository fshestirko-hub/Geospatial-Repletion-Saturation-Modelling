...
def run_district_assignment(spark: SparkSession, project_root: Path) -> dict[str, Path]:
    ...
    from src.step_11_geospatial_streaming import add_synthetic_coordinates
    from src.step_14_geospatial_visualization import create_interactive_playback_map
