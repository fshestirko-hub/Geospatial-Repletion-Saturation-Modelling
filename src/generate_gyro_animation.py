...
def generate_gyro_animation(activity="walk", color="#33FF57", title_label="Walking"):
    ...
    if os.path.exists(gif_path):
        print(f"DEBUG: 3D gyroscope attractor GIF for {activity} already exists. Skipping generation.")
        return
    ...
    if active_session is not None:
        ...
        print(f"DEBUG: Reusing active Spark Session for {title_label} Gyroscope animation.")
    else:
        print(f"DEBUG: Initialising new Spark Session for {title_label} Gyroscope animation...")
